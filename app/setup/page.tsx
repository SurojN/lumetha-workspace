      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg p-6 space-y-3">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg p-6 space-y-4">
              <div>
                ...
                <code className="block bg-slate-100 dark:bg-slate-800 p-3 rounded text-sm text-slate-900 dark:text-slate-100 overflow-x-auto">
              ...
              <div>
                ...
                <code className="block bg-slate-100 dark:bg-slate-800 p-3 rounded text-sm text-slate-900 dark:text-slate-100">
                  npx create-db
                </code>
              </div>
            </div>
